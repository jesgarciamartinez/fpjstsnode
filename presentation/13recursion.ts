/*
  ...
  See book: Structure and Interpretation of Computer Programs, 1st chapter:
...
/*
  ES2015 included "tail recursion optimization" in the JS spec, but browsers (and node, which runs on V8) don't implement it.
 */
